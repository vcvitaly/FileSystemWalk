...
func TestRunDelExtension(t *testing.T) {
	testCases := []struct {
		...
		{name: "DeleteExtensionNoMatch", cfg: config{ext: ".log", del: true}, extNoDelete: ".gz", nDelete: 0,
			nNoDelete: 10, expected: ""},
		{name: "DeleteExtensionMatch", cfg: config{ext: ".log", del: true}, extNoDelete: "", nDelete: 10,
			nNoDelete: 0, expected: ""},
		{name: "DeleteExtensionMixed", cfg: config{ext: ".log", del: true}, extNoDelete: ".gz", nDelete: 5,
			nNoDelete: 5, expected: ""},
	}
...
func createTempDir(t *testing.T, files map[string]int) (dirname string, cleanup func() error) {
	t.Helper()
